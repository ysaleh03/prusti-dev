use crate::{
    encoders::{
        ...
        predicate::{
            PredicateBuilder, PredicateEncData, PredicateEncDataPurifiedImmRef, RefToIndirectPred,
        },
...
pub(crate) fn domain<'vir>(
    ...
    builder.axiom("typeof", vir::expr! {
        forall p: [inner_type] ::
            ...
            ([output_ref.typeof_function](([cons_ident](p)) as Snap)) == ([ty_type_func.ty_constructor]([[generic_enc.param_type_function](p)]))
    });
